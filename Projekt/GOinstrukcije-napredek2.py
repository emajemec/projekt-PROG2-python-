...
for s in instruktorji:
    ...
    print(ime, predmeti, razpolozljivost, cena, reference, kraj, starost, ure, ucenci, urlslika)
...
# and Predmet in instr.predmet
    
prejsnjaOcena = 0
for instr in seznam.sez:
    if instr.kraj == TvojKraj:
